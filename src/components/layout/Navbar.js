				...
				<ul className="navbar-nav navbar-align">
					...
					<li className="nav-item dropdown">
						...
						<a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
							<img src="adminkit/img/avatars/avatar.jpg" className="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span className="text-dark">{(accounts.length > 0 && accounts[0] != null) && accounts[0].name}</span>
						</a>
						<div className="dropdown-menu dropdown-menu-end">
							...
							<div className="dropdown-divider"></div>
							<a className="dropdown-item" href="#" onClick={() => handleLogout("redirect")}>Log out</a>
						</div>
					</li>
				</ul>
			</div>
